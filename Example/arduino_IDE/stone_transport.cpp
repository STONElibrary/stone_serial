...
/*	                       JSON_END
 *
 *  ����Ҫ����ָ��ST<{"cmd_code":"sys_reboot","type":"system"}>ET
 *	ʹ�÷���Ϊ :
 *   STONE_JSON ("cmd_code", "sys_reboot");
 *   STONE_JSON ("type", 		 "system", 		JSON_END);
 *	
 *	���緢��ָ��ST<{"cmd_code":"set_value","type":"label","widget":"label2","value":1.23,"format":"%.2f"}>ET
 *	ʹ�÷���Ϊ��
...
void set_sys(char* _cmd){    
  if (strcmp(_cmd,STR_SYS_REBOOT)==0 || 
	...
	#if MCU_ARDUINO || MCU_ESP			//ʹ��Arduino������ʱ�����ڹ۲췢�͸�ʽ�Ƿ���ȷ
  else
		{
...
/* ���ÿؼ��ɼ�״̬��ָ�������ӿ� */
// ����ʾ�� set_visible("switch1", "false");
#define set_visible(m_name, m_tf) set_enable(m_name, m_tf, 1)

/* ���ÿؼ�����λ�õ�ָ�������ӿ� */
// ����ʾ�� set_coordinate("switch1", "100", "200");
...
/* �����ı�ָ�������ӿ� */
// ����ʾ�� set_text("label", "label5", "hello stone");
...
/* ����ֵָ�������ӿ� */
// ����ʾ�� set_value("slider", "slider2", "66");
//     ʾ��2 set_value("label", "label5", "66.6", "%.2f");
...
/* ��ʾ�ı�ָ�������ӿ� */
// ����ʾ�� show_text("progress_bar1", "true");
...
/* ����ͼƬ����������ָͣ�������ӿ� */
// ����ʾ�� set_pause("image_animation1");
#define set_pause(m_name) set_play(m_name,1)

///* ����ͼƬ��������ָֹͣ�������ӿ� */
//// ����ʾ�� set_stop("image_animation1");
#define set_stop(m_name) 	set_play(m_name,2)

/* ���ø�ʽָ�������ӿ� */
// ����ʾ�� set_format("image_value", "iamge_value1", "%02.2f");
...
/* ����ͼƬָ�������ӿ� */
// ����ʾ�� set_image("image_value", "iamge_value1", "light_on");
...
//		TX_CNT += sprintf(STONE_TX_BUF+TX_CNT,STR_TYPE);
//		TX_CNT += sprintf(STONE_TX_BUF+TX_CNT,"\":\"");
//		TX_CNT += sprintf(STONE_TX_BUF+TX_CNT,"\"%s\"",_type);
//		TX_CNT += sprintf(STONE_TX_BUF+TX_CNT,"\",\"");
//		TX_CNT += sprintf(STONE_TX_BUF+TX_CNT,STR_WIDGET);
//		TX_CNT += sprintf(STONE_TX_BUF+TX_CNT,"\":\"");
//		TX_CNT += sprintf(STONE_TX_BUF+TX_CNT,"\"%s\"",_name);
...
//		TX_CNT += sprintf(STONE_TX_BUF+TX_CNT,STR_IMAGE);
//		TX_CNT += sprintf(STONE_TX_BUF+TX_CNT,"\":\"");
//		TX_CNT += sprintf(STONE_TX_BUF+TX_CNT,"\"%s\"",_image);
//		TX_CNT += sprintf(STONE_TX_BUF+TX_CNT,STR_END);
		 tx_create();
  }
  #if MCU_ARDUINO || MCU_ESP
...
/* ����ѭ������ָ�������ӿ� */
// ����ʾ�� set_loop("image_animation1", "true");
...
/* ���÷�Χָ�������ӿ� */
// ����ʾ�� set_range("image_animation1", "1" , "10");
...
/* ����ͼƬ��ʾ��ʽָ�������ӿ� */
// ����ʾ�� set_draw_type("image", "image1" , "2");
...
/* �����ı�ѡ������ǰѡ����ָ�������ӿ� */
// ����ʾ�� set_selected("text_selector1", "20");
...
/* ��������ָ�������ӿ� */
// ����ʾ�� set_date("2022-02-22 22:22:22");
